...
namespace VM76 {
	...
	void key_callback(GLFWwindow* window, int key, int scancode, int action, int mods) {
		...
		if (PRESS(GLFW_KEY_W)) obj->pos = obj->pos + glm::vec3(0.5, 0.0, 0.0);
		if (PRESS(GLFW_KEY_S)) obj->pos = obj->pos + glm::vec3(-0.5, 0.0, 0.0);
		if (PRESS(GLFW_KEY_A)) obj->pos = obj->pos + glm::vec3(0.0, 0.0, -0.5);
		if (PRESS(GLFW_KEY_D)) obj->pos = obj->pos + glm::vec3(0.0, 0.0, 0.5);
